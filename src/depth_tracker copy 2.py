...
print("Loading depth estimation model... This may take a moment.")
print("Trying ZoeDepth (metric depth model)...")
depth_estimator = DepthEstimator(model_type='zoedepth')  # Metric depth model
